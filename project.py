    ...
    for video_id in video_ids:
        try:
            ...
            if e.resp.status == 403 and "commentsDisabled" in str(e):
                ...
                print(f"Failed to fetch comments for video ID: {video_id} due to error: {e}")
                continue  # You can choose to `raise` here if you don't want to continue
...
st.set_page_config(page_title='Harshini Streamlit')
